		...
		\begin{lstlisting}[language=json,firstnumber=1]
{
 ...
 order by  l_returnflag,  l_linestatus;
	...
	Při aktualizacích dojde ke změně hodnot všech 10 polí vybraného záznamu. Definice aktualizace je uvedena v ukázce na obrázku~\ref{json-ycsb-operace-update}. Přistoupí se k tabulce "usertable"~a pomocí klíče "user1474"~se aktualizují všechny hodnoty v polích "field0"~až "field9"~na hodnoty "new\_value0"~až "new\_value9".
