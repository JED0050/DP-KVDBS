...
\begin{document}
	...
	Do databáze bylo vždy vloženo 100 000 záznamů a následující test prováděl 1 000 000 dotazů nad danou naplněnou databází. Následně byla DBS vyprázdněna, reinstalována a celý proces se opakoval ještě dvakrát.
	
	Testy byly prováděny ve třech YCSB kategoriích. Workload A (Update-heavy: 50\% read, 50\% update), Workload B (Read-mostly: 95\% read, 5\% update) a Workload C (Read-only) (viz YCSB Workloads \ref{lab-workloads}).
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Workloads A, B, C + Insert only - Throughput (kiloops/sec)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Workloads A, B, C + Insert only - Runtime (s)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Workloads A, B, C + Insert only - Max Latency (ms)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Workload A - Min Avg Latency (ms)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Workload B - Min Avg Latency (ms)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Workload C - Min Avg Latency (ms)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Insert only - Min Avg Latency (ms)}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{Insert only - Percentile Latency (ms)}
