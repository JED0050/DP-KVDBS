	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}[scale=0.5]
			\begin{axis}[
				...
				\addplot coordinates {(Workload A,2.219) (Workload B,3.195) (Workload C,3.195) (Insert only,3.195)};
				\addplot coordinates {(Workload A,1.11933) (Workload B,1.690) (Workload C,3.195) (Insert only,3.195)};
				\addplot coordinates {(Workload A,1.5366) (Workload B,2.32233) (Workload C,3.195) (Insert only,3.195)};
				\addplot coordinates {(Workload A,4.3863) (Workload B,8.12433) (Workload C,3.195) (Insert only,3.195)};
				\legend{Redis,Aerospike,Memcached,Riak KV}
			\end{axis}
		\end{tikzpicture}
		\caption{Workload A - Throughput (ops/sec)}
		\label{graph_Workload A - Throughput (ops/sec)}
	\end{figure}
